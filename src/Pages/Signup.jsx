...
export const Signup = () => {
  return (
    <>
   <div className="w-screen h-screen  grid grid-cols-2 my:ml-[-50px] sm:grid-cols-1  ">
    <div className="w-[593px] my:w-[500px] ipad:w-[300px] sm:w-[200px] sm:ml-[110px] ipad:ml-[40px] sm:mt-[50px] h-[544px] ml-[81px] mt-[275px] mr-[766px] my:mr-[400px] mb-[261px]  ">
      <img src={login} alt=""  className=""/>
    </div>
    <div className="  mr-[107px] ipad:mr-[70px] sm:mt-[-600px] sm:mb-[40px]    mt-[148px] ">
      <div className="pt-[65px]  lg:w-[630px] my:w-[600px] lg:h-[830px] ipad:w-[400px] sm:w-[350px] sm:ml-[30px] ipad:ml-[-50px]   bg-white rounded-[5px] shadow-[0px_4px_4px_#00000040]" >
      ...
      <p className="mt-[20px] [font-family:'Inter-Light',Helvetica] font-light text-[#898989] text-[20px] text-center tracking-[-0.30px] leading-[31.7px] whitespace-nowrap">
      ...
      <div className="w-[362px] ipad:w-[340px] sm:w-[315px] h-[64px] mt-[10px] flex justify-evenly  rounded-[5px] border border-solid border-violet-100">
        <img className=" w-[16px] h-[21px] mt-[22px] ml-[9px]  object-cover" alt="Line" src={password} />
      <input type="password" placeholder="Retype Your Password Here" className="mr-[50px] w-[220px] px-3 focus:outline-none   "  />
      </div>
      ...
      <button className=" w-[112px]  h-[34px] mt-4 text-center ml-[135px] text-white bg-[#168356] rounded-[5.15px] border-[0.86px] border-solid border-[#18a0fb]">Sign Up</button><br/>
      </NavLink>
      ...
      <div className="w-[244px] h-[17px] mt-[49px] ml-[75px] sm:ml-[25px]  ">
      <p className="[font-family:'Inter-Regular',Helvetica] font-normal text-transparent text-[14px] text-center tracking-[0] leading-[normal]">
        <span className="text-[#1e1e1e66]">Already Have an account?</span>
        <span className="text-[#000000b2]">&nbsp;</span>
        <NavLink to='/signin'>
        <span className="[font-family:'Inter-Medium',Helvetica] font-medium text-[#3792de]">Signin Now.</span>
        </NavLink>
      </p>
    </div>
      </form>
